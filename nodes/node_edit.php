...
<div class="container px-4 py-5">
  ...
  <form method="post" id="meterUpdate" action="<?php echo $_SERVER['REQUEST_URI']; ?>">
    <div class="mb-3">
      ...
      <input type="text" class="form-control" id="name" name="name" placeholder="Meter Name" value="<?php echo $node->name; ?>">
    </div>
    <div class="mb-3">
