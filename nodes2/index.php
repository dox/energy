					...
					<div class="card-header">
						<div class="row align-items-center">
							...
							<div class="col text-end">
								<a href="index2.php?n=readings" class="btn btn-sm btn-primary">See all</a>
							</div>
						</div>
					</div>
						...
						<table class="table align-items-center table-flush">
							...
							<tbody>
								...
								foreach ($recentReadings AS $reading) {
									...
									$output .= "<td class=\"fw-bolder text-gray-500\"><a href=\"index2.php?n=node&nodeUID=" . $meter->uid . "\">" . $meter->name . "(" . $location->name . ")</a></td>";
